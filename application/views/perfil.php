		...
		<?php
				 if($datos=="direcciones"){ //direcciones
					 ...
					 foreach($direcciones as $direccion){
						 ...
						 echo "<a href=".site_url('direccion/modificiar')."?id=".$direccion->id."><span class=\"glyphicon glyphicon-pencil\" aria-hidden=\"true\"></span></a>";
						 echo " <a href=".site_url('direccion/borrar')."?id=".$direccion->id."><span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\"></span></a>";
						 echo "</div>";
						 echo	"</div>";
						 $posicion++;
				 	 }
